...
export const userProfiles = pgTable("user_profiles", {
  ...
  goalWaistCm: numeric("goal_waist_cm", { precision: 5, scale: 2 }),
  goalNeckCm: numeric("goal_neck_cm", { precision: 5, scale: 2 }),
  goalHipCm: numeric("goal_hip_cm", { precision: 5, scale: 2 }),
